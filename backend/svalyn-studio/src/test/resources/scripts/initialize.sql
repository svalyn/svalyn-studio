INSERT INTO account (id, role, username, name, email, created_on, last_modified_on) VALUES
('7ba7bda7-13b9-422a-838b-e45a3597e952', 'USER', 'johndoe', 'John Doe', 'johndoe@example.org', '2022-09-17 21:37:52.616', '2022-09-17 21:37:52.616');

INSERT INTO account (id, role, username, name, email, created_on, last_modified_on) VALUES
('1116f75f-2ceb-43cf-b6a6-c11dabbc5977', 'USER', 'janedoe', 'Jane Doe', 'janedoe@example.org', '2022-09-25 14:25:52.616', '2022-09-25 14:25:52.616');

INSERT INTO account (id, role, username, name, email, created_on, last_modified_on) VALUES
('5e45aead-48f2-462b-a50e-1191ace697bd', 'USER', 'julesdoe', 'Jules Doe', 'julesdoe@example.org', '2022-09-27 08:25:52.616', '2022-09-27 08:25:52.616');

INSERT INTO account (id, role, username, name, email, created_on, last_modified_on) VALUES
('a685c7d7-b4a4-4d58-8f76-ef05e6392fe4', 'USER', 'jamesdoe', 'James Doe', 'jamesdoe@example.org', '2022-09-28 17:29:52.616', '2022-09-28 17:29:52.616');

INSERT INTO account (id, role, username, name, email, created_on, last_modified_on) VALUES
('4164c661-e0cb-4071-b25d-8516440bb8e8', 'ADMIN', 'admin', 'Admin', 'admin@example.org', '2022-11-12 18:29:52.616', '2022-11-12 18:29:52.616');
